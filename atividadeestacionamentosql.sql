...
alter table carro column chassi char (8);
...
values(1,'jeep','compass','12645897563006579',2),
	  (2,'volkswagen', 'gol','325679871005498761',4),
      (3,'ford','KA','6458976230146980',3),
      (4,'fiat','uno','25697846321564895',5),
      (5,'chevrolet','camaro','56478945623014569',1);
